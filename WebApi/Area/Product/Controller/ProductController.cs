...
namespace WebApi.Area.Product.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateProductAsync([FromBody] ProductDetailCreateModel productDetails)
        {
            ...
            try
            {
                var modelDB = _mapper.Map<ProductDetailCreateModel, Products>(productDetails);
        ...
        public async Task<ActionResult<ProductDetailRetrieveModel>> GetProductDetailsByIdAsync(int id)
        {
            try
            {
                ...
                {
                    var modelDTO = _mapper.Map<Products, ProductDetailRetrieveModel>(modelDB);
                    return Ok(modelDTO);
                }
            }
            catch (Exception ex)
        ...
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<Products>> GetProductListAsync([FromQuery] ProductQueryableParameter parameter)
        {
        ...
        public async Task<ActionResult> UpdateProductDetailsById(int id, [FromBody] ProductDetailUpdateModel productDetails)
        {
            ...
            try
            {
                ...
                {
                    modelDB = _mapper.Map<ProductDetailUpdateModel, Products>(productDetails);
